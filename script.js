  ...
  sellerForm.addEventListener(
    ...
    function (event) {
      ...
      if (
        ...
        alert(
          "Please choose a screenshot of the account first."
        );
...
Please review this account submission.

I will send the account screenshot separately in this WhatsApp chat.
`;
